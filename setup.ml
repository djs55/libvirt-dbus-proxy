...
(* OASIS_START *)
(* DO NOT EDIT (digest: 737ff8bcca96def2d67720edb17488d0) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "domain_events.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "o(\157\185\180\153\t<\020\168\150\136\231e\215I";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
